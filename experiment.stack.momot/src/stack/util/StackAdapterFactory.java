...
public class StackAdapterFactory extends AdapterFactoryImpl {
	...
	protected StackSwitch<Adapter> modelSwitch =
		new StackSwitch<Adapter>() {
			@Override
			public Adapter caseStackModel(StackModel object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link stack.StackModel <em>Model</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link stack.Stack <em>Stack</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
